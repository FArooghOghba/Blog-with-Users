...
class BlogPost(db.Model):
    ...
    blog_post_comments = relationship("Comment", back_populates="post_comment")
...
class Comment(db.Model):
    ...
    author_id = db.Column(db.Integer, db.ForeignKey("blog_users.id"))
    comment_author = relationship("User", back_populates="blog_comments")

    comment_post_id = db.Column(db.Integer, db.ForeignKey("blog_posts.id"))
    post_comment = relationship("BlogPost", back_populates="blog_post_comments")
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if not user:
            flash("The email does not exist, please signup!")
